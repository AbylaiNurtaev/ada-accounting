...
export function CaseCard({ item, index }: CaseCardProps) {
  return (
    <motion.article
      className="group relative flex h-full min-h-[270px] flex-col overflow-hidden rounded-lg border border-white/[0.07] bg-black/50 shadow-[0_24px_80px_-32px_rgba(0,0,0,0.85)] backdrop-blur-xl transition-[box-shadow] duration-500 will-change-transform sm:min-h-[420px] sm:rounded-2xl"
    ...
    >
      <div className="pointer-events-none absolute -inset-px rounded-lg opacity-100 transition-opacity duration-500 sm:rounded-2xl">
      ...
      <div className="relative flex min-h-0 flex-1 flex-col">
        <div className="relative aspect-[4/3] min-h-[105px] overflow-hidden sm:aspect-[16/11] sm:min-h-[280px]">
          ...
          <div className="h-full w-full origin-center transition-transform duration-[650ms] ease-[cubic-bezier(0.22,1,0.36,1)]">
            <img
              src={item.image}
              alt={item.title}
