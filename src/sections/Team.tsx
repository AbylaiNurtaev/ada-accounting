  ...
  return (
    <AnimatedSection id="team" className="py-16 md:py-20">
      <div className="container">
        <div className="mx-auto max-w-3xl rounded-2xl bg-black px-5 py-8 shadow-[0_24px_64px_rgba(0,0,0,0.45)] ring-1 ring-white/10 md:px-10 md:py-10">
          <div className="flex justify-center">
            <p className="rounded-full bg-[#FFFF00] px-6 py-2.5 text-center text-sm font-bold leading-none text-black md:text-base">
              Наша команда:
            </p>
          </div>
          ...
          <p className="mt-8 text-center text-xs italic leading-relaxed text-[#FFFF00] sm:text-sm md:text-base">
